...
?>
<div <?php print danland_peenolab_page_class($page['sidebar_first'], $page['sidebar_second']); ?>>
<div id="header">
<div id="header-wrapper">
	<?php if ($page['user_bar_first'] || $page['user_bar_second']): ?>
		<div id="user-bar-wrapper">	
		<?php if ($page['user_bar_first']): ?>
			<div id="user-bar-first">
				<?php print render ($page['user_bar_first']); ?>
			</div><!-- /user-bar-first -->
		<?php endif; ?>
		<?php if ($page['user_bar_second']): ?>
			<div id="user-bar-second">
				<?php print render ($page['user_bar_second']); ?>
			</div><!-- /user-bar-second -->
		<?php endif; ?>
		</div><!-- end user-bar-wrapper -->
	<?php endif; ?>
	<?php if ($logo): ?> 
		<div id="logo-wrapper">
			<div class="logo">
...
<div class="slideshow">
<img src="<?php print $base_path . $directory; ?>/images/slideshows/sea1200x315.png" width="1200" height="315" alt="slideshow 1"/>
<img src="<?php print $base_path . $directory; ?>/images/slideshows/noon1200x315.png" width="1200" height="315" alt="slideshow 2"/>
<img src="<?php print $base_path . $directory; ?>/images/slideshows/snow1200x315.png" width="1200" height="315" alt="slideshow 3"/>
</div>
</div>
</div>
<?php endif; ?>
